// copied from https://github.com/paxcode-it/zod-to-fields
import { ZodArray, ZodNullable, ZodObject, ZodOptional, type ZodTypeAny, type z } from "zod";
import type { UnwrapZodType } from "./_model";
 ...
 */
const zodKeys = (schema: ZodTypeAny, parentKey = ""): string[] => {
...
const unwrapZodType = <T extends z.ZodTypeAny>(zodType: T): UnwrapZodType<T> => {
