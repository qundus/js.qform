...
function isZodEnum<T extends [string, ...string[]]>(value: z.ZodTypeAny): value is z.ZodEnum<T> {
	return value instanceof z.ZodEnum;
}

// Type Guard for ZodNativeEnum
function isZodNativeEnum<T extends EnumLike>(value: z.ZodTypeAny): value is z.ZodNativeEnum<T> {
